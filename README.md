...
1. **Overall Sentiment Distribution:** Created a pie chart to visualize the proportion of positive, negative, and neutral sentiments across the entire dataset.
2. **Brand/Topic Specific Sentiments:** Filtered the top 5 most discussed entities (brands/topics) and created a clustered bar chart to analyze how public opinion varies across these specific subjects.
